...
import classes from "./TypesOfRoofing.module.scss";
import {
  asphaltPng,
  cedarPng,
  commercialPng,
  ...
  replacePng,
  slatePng,
} from "../../../assets/img/icons/typesOfRoofing";

const TypesOfRoofing = () => {
  const types = [
    {
      iconUrl: replacePng,
  ...
  return (
    <Section className={classes.TypesOfRoofing}>
      <Wrapper>
        <h2>Types of Roofing</h2>
        <div className={classes.TypesOfRoofing_container}>
          {types.map((service) => (
            <div key={service.name} className={classes.TypesOfRoofing_item}>
              <img
                src={service.iconUrl}
                alt={service.name}
                className={classes.TypesOfRoofing_itemImage}
              />
              <h3>{service.name}</h3>
